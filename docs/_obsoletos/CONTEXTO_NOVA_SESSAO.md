...
6. **BACEN:** prioridade dupla — pasta da cliente primeiro, fallback `Série do Bacen/MM-YYYY.pdf`. **Mês de referência é o da Data de Emissão (Item II), não o do 1º vencimento** (v0.5.3+).
...
- Data de emissão 22/09/2025 → BACEN `09-2025` (não o mês do 1º vencimento 27/10/2025)
...
- Data de emissão 29/12/2025 → BACEN `12-2025` (não `02-2026` do 1º vencimento); taxa conforme PDF `12-2025.pdf` na série BACEN
